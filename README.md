...
1. Install cuda for your GPU ex: [NVIDIA](https://developer.nvidia.com/cuda-downloads)
2. Install [pytorch](https://pytorch.org/get-started/locally/)
3. Clone this repo. `git clone https://github.com/anbuhckr/stable-diffusion-optimized.git`
4. `cd` into `~/stable-diffusion-optimized/script`
5. `pip install transformers==4.19.2 invisible-watermark`
6. `pip install accelerate ftfy`
7. Download model [sd-v1-4.ckpt](https://f004.backblazeb2.com/file/aai-blog-files/sd-v1-4.ckpt)
8. Create directory `mkdir models` and add the model `mv sd-v1-4.ckpt models/modelckpt`
...
`python3 img2img.py --prompt "Austrian alps" --init-img ~/sketch-mountains-input.jpg --strength 0.8 --n_iter 2 --n_samples 5 --H 512 --W 512`
...
`python3 txt2img.py --prompt "Cyberpunk style image of a Tesla car reflection in rain" --H 512 --W 512 --seed 27 --n_iter 2 --n_samples 5 --ddim_steps 50`
...
- To launch the gradio interface for inpainting, run `python3 inpaint_gradio.py`. The mask for the image can be drawn on the selected image using the brush tool.
...
- Run img2img using `python3 img2img_gradio.py`, txt2img using `python3 txt2img_gradio.py` and inpainting using `python3 inpaint_gradio.py`.
